...
class Board:
    ...
    def _i2c_write(self, reg, data):
        """Escribe *data* en *reg* usando block write como en la demo oficial."""
        ...
        for attempt in range(I2C_MAX_RETRIES):
            try:
                # El fabricante usa siempre write_i2c_block_data (incluso para 1 byte).
    ...
    def stop(self):
        """Detiene los 4 motores enviando 0 en velocidad y PWM."""
